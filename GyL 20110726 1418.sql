...
--
-- Temporary table structure for view `vis_permisos`
--
DROP TABLE IF EXISTS `vis_permisos`;
DROP VIEW IF EXISTS `vis_permisos`;
CREATE TABLE `vis_permisos` (
  `idrel_usuarios_roles_instituciones` int(11),
  `idrel_usuarios_instituciones` int(11),
  `idusuario` int(11),
  `logusuario` varchar(50),
  `pass` varchar(33),
  `nombre` varchar(100),
  `apellido` varchar(100),
  `usuarioactivo` tinyint(4),
  `idrol` int(11),
  `rol` varchar(100),
  `activo` bit(1),
  `codigo_identificacion` varchar(50),
  `formas_conocidas_nombre` varchar(100),
  `tipo_institucion` varchar(50),
  `tipo_entidad` varchar(50),
  `telefono_de_contacto` varchar(50),
  `email` varchar(50),
  `www` varchar(50),
  `historia` text,
  ...
  `instalaciones_archivo` varchar(255),
  `fondos_agrupaciones` varchar(100),
  `tipo_acceso` varchar(50),
  `requisito_acceso` varchar(100),
  `acceso_documentacion` varchar(255),
  `dias_apertura` varchar(255),
  `horaios_apertura` varchar(255),
  `fechas_anuales_cierre` varchar(255),
  `codigo_interno` int(11),
  `estado` int(11),
  `fecha_ultima_modificacion` datetime,
  `usuario` varchar(50)
);
...
INSERT INTO `area_de_notas_instituciones` (`codigo_notas`,`codigo_institucion`,`nota_descripcion`,`fecha_descripcion`,`fecha_modificacion`) VALUES 
 ...
 (24,'AR/PN/SC/DNPM/CNS','Sí&nbsp;hay datos.','2011-06-29 00:00:00','2011-07-01 00:00:00'),
 (26,'AR/PN/SCN/DNPM/MHS','\r\n\r\n<p>No hay datos</p>','2011-07-14 00:00:00','2011-07-14 00:00:00'),
 (27,'AR/PN/SCN/DNPM/INET','El archivo se encuentra en proceso de <span style=\"COLOR: rgb(255,20,147)\">mudanza</span><br />\r\n','2011-07-24 00:00:00','2011-07-26 00:00:00');
...
INSERT INTO `direcciones_instituciones` (`codigo_direcciones`,`codigo_institucion`,`calle`,`numero`,`codigo_postal`,`provincia`,`casilla_correo`,`ciudad`,`pais`,`telefonos`,`fax`,`tipo_direccion`) VALUES 
 ...
 (35,'DNPYM','Alsina','1169','1311','Buenos Aires','dnpm@cultura.gov.ar','Ciudad Autónoma de Buenos Aires','Argentina','4381-6656      ','4382-5709 int 114',NULL),
 (36,'DNPYM','Alvear','1690','C1014AAQ ','Buenos Aires','dnpm@cultura.gov.ar','Ciudad Autónoma de Buenos Aires','Argentina','4129-2486',NULL,NULL),
 (37,'AR/PN/SCN/DNPM/MHS','Cuba','2079','1426',NULL,NULL,'Buenos Aires','Argentina','47837555','47837555',NULL),
 (38,'AR/PN/SCN/DNPM/INET','Av. Córdoba ','1199  ','| CP 1055 |','-','-','Ciudad Autónoma de Buenos Aires ','Argentina','5411 4815-8817 y 8883','-',NULL);
...
INSERT INTO `documentos` (`codigo_referencia`,`codigo_institucion`,`titulo_original`,`titulo_atribuido`,`titulo_traducido`,`fecha_registro`,`numero_registro_inventario_anterior`,`numero_inventario_unidad_documental`,`cod_ref_sup`,`tipo_general_documento`,`tipo_especifico_documento`,`tradicion_documental`,`numero_registro_sur`,`numero_registro_bibliografico`,`sistema_organizacion`,`autor`,`nombre_productor`,`fecha_edicion_anio_editorial`,`fecha_accion_representada`,`version`,`genero`,`signos_especiales`,`fecha_inicial`,`fecha_final`,`alcance_contenido`,`soporte`,`duracion_metraje`,`cromia`,`tecnica_fotografica`,`tecnica_visual`,`tecnica_digital`,`emulsion`,`sonido`,`integridad`,`forma_presentacion_unidad`,`cantidad_fojas_album`,`caracteristica_montaje`,`requisito_ejecucion`,`unidades`,`cantidad_envases_unidad_documental`,`coleccion`,`evento`,`manifestacion`,`forma_ingreso`,`procedencia`,`fecha_inicio_ingreso`,`precio`,`norma_legal_ingreso`,`numero_legal_ingreso`,`numero_administrativo`,`derechos_restricciones`,`titular_derecho`,`tipo_acceso`,`requisitos_acceso`,`acceso_documentacion`,`servicio_reproduccion`,`publicaciones_instrumentos_accesos`,`subsidios`,`normativa_legal_baja`,`numero_norma_legal`,`motivo_baja`,`fecha_baja`,`tipo_diplomatico`,`situacion`,`fecha_ultimo_relevamiento_visu`,`tv`,`na`,`estado`,`fecha_creacion`,`fecha_ultima_modificacion`,`usuario`,`fecha_ultimo_tratamiento`,`restringido_exhibicion`,`fecha_ultima_gestion`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C/com1_1','AR/PN/SC/DNPM/CNS',NULL,NULL,NULL,NULL,NULL,NULL,'AR/PN/SC/DNPM/CNS/C',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'Local',NULL,3,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/CNS/C/com1_2','AR/PN/SC/DNPM/CNS',NULL,NULL,NULL,NULL,NULL,NULL,'AR/PN/SC/DNPM/CNS/C',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,9,'Local',NULL,3,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/CNS/C/DOCAUVI02','AR/PN/SC/DNPM/CNS',NULL,NULL,NULL,NULL,NULL,NULL,'AR/PN/SC/DNPM/CNS/C',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,9,'Local',NULL,2,1,1,NULL,'2011-06-12 19:39:29','camilo',NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/CNS/C/DOCSON','AR/PN/SC/DNPM/CNS','Documento Sonoro','Nuevo Titulo del documento',NULL,'2010-01-01 00:00:00',NULL,'01','AR/PN/SC/DNPM/CNS/C','Sonoro','Film','Copia auténtica',NULL,NULL,NULL,NULL,'Casa Natal de Sarmiento. Monumento Histórico','2011','09-06-2011',NULL,NULL,NULL,'2000-01-01 00:00:00','2000-01-01 00:00:00','No hay datos','DVD','00:59:00',NULL,NULL,NULL,NULL,NULL,NULL,'Intacto',NULL,NULL,NULL,NULL,200,NULL,NULL,NULL,NULL,'Hallazgo','procedencia','09-06-2011','100.000 pesos argentinos','Resolución','01/02',NULL,'No hay datos',NULL,NULL,NULL,NULL,NULL,'si hay datos',NULL,NULL,NULL,NULL,NULL,10,'Robado','2009-01-27 00:00:00',2,3,5,NULL,'2011-07-04 16:41:58','camilo',NULL,1,'2011-07-01 00:00:00'),
 ('AR/PN/SC/DNPM/CNS/C/DOCVIS01','AR/PN/SC/DNPM/CNS','Casa Natal Sarmiento',NULL,NULL,'2010-01-01 00:00:00',NULL,'123','AR/PN/SC/DNPM/CNS/C','Visual','Videos','Copia digital',NULL,NULL,'Cronológico','Atahualpa Yupanqui','Casa Natal de Sarmiento. Monumento Histórico',NULL,'Agosto 2004',NULL,NULL,': Dibujo a mano alzada en tinta sobre lateral izquierdo, autorretrato y retrato de Atahualpa Yupanqui, presumiblemente de autoría de Ricardo Rojas.','1911-01-01 00:00:00','2008-01-01 00:00:00','El acervo contiene documentación referida a: adquisición del edificio, declaración Monumento Histórico, trabajos de refacciones y reconstrucción parcial desde l911 a la fecha, instalación de servicios que se fueron logrando a lo largo del tiempo, como: en','DVD','01:00:00 hrora','Color','Otras','Serigrafía','BMP','Colodión','Sonoro','Intacto','Álbum desarmable (ganchos, tiras, cintas, otros)',NULL,NULL,NULL,100,NULL,NULL,NULL,NULL,'Donación','Producción y donaciones ','2010/02/25','15.000 pesos argentinos','Decreto','00000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Acceso restringido. Su consulta está permitida según el Reglamento General de este Archivo, al personal del mismo, bajo recibo y bajo autorización de la Dirección.',NULL,NULL,NULL,NULL,NULL,8,'Robado','2010-01-01 00:00:00',2,1,5,NULL,'2011-07-04 17:51:44','camilo',NULL,NULL,'2010-02-01 00:00:00'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/DOC01','AR/PN/SC/DNPM/CNSDR','TIKANDVPADS','DFJWR','RGJKWTR,M','2011-01-01 00:00:00','1254','125487','AR/PN/SC/DNPM/CNSDR/fdo01','Audiovisual','Grabados','Copia electrónica',NULL,NULL,NULL,NULL,'Productor',NULL,'RTJHR',NULL,NULL,'RGHRATH','2009-01-01 00:00:00','2011-01-01 00:00:00','SFHR','Canson','AJMAR','Blanco y Negro','Ambrotipo','Grabado en relieve - Fototipía','No especificado','Colodión','Mixto','RYMJARYJ','Álbum encuadernado cosido',0,'Con esquineros',NULL,0,NULL,NULL,NULL,NULL,'Compra','ARTHTRJ','RHTRJHR','RTJRQJ','Resolución','RTJHRT',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'RJQRTHRTHRTHRTH',NULL,NULL,NULL,NULL,NULL,8,'Local','2009-01-01 00:00:00',2,5,5,NULL,'2011-06-15 16:18:46','camilo',NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/auvisu','AR/PN/SC/DNPM/CNSDR',NULL,NULL,NULL,NULL,NULL,NULL,'AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,9,'Local',NULL,9,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/son','AR/PN/SC/DNPM/CNSDR','Original','Atribuido','Traducido.','2010-01-01 00:00:00',NULL,'1254','AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp','Hemerográfico','Recorte visual impreso','Copia auténtica',NULL,NULL,NULL,NULL,'CDR',NULL,'10 de enero',NULL,NULL,NULL,'2010-01-01 00:00:00','2010-01-01 00:00:00','Alcance','Betamax','00 hrs 50 min 60 seg',NULL,NULL,NULL,NULL,NULL,NULL,'A reparar',NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,'Compra','Compra','01/01/2000','2154 pesos','Disposición','125478',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Publicaciones',NULL,NULL,NULL,NULL,NULL,10,'Robado','2011-12-12 00:00:00',9,1,5,NULL,'2011-07-05 11:27:24','camilo',NULL,NULL,'2011-12-12 00:00:00'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/text','AR/PN/SC/DNPM/CNSDR','Titulo','Titulo','Titulo','2001-01-01 00:00:00','123','123','AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp','Audiovisual','Recorte textual manuscrito','Copia auténtica',NULL,NULL,NULL,NULL,'CDR',NULL,'asdfadf',NULL,NULL,'sdfadsf','2001-01-01 00:00:00','2002-02-01 00:00:00','adsfadsf','VHS',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1341234','Encuadernado cosido',NULL,NULL,NULL,12,NULL,NULL,NULL,NULL,'Donación','sdfasdf','asdfads','12','Decreto','12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'sdfaadsfad',NULL,NULL,NULL,NULL,NULL,11,'Robado','2003-01-01 00:00:00',9,5,5,NULL,'2011-07-05 11:23:17','camilo',NULL,NULL,'2002-01-01 00:00:00'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/visu','AR/PN/SC/DNPM/CNSDR','t','t','t','2009-01-01 00:00:00','321','123','AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp','Textual','Imagen en mapa de bits','Copia digital',NULL,NULL,'Cronológico','Atahualpa Yupanqui','CDR','02/07/2011','02/02/2009',NULL,NULL,'signos especiales','2010-01-01 00:00:00','2011-01-01 00:00:00','Alcance','Betamax','00','Sepia','Calotipo','Grabado en relieve - Fototipía','No especificado','Colodión','Mixto','intacto','Álbum desarmable (ganchos, tiras, cintas, otros)',NULL,NULL,NULL,1000,NULL,NULL,NULL,NULL,'Compra','p','02/02/2011','20000','Decreto','12112212121',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'p',NULL,NULL,NULL,NULL,NULL,8,'No Localizado','2010-01-01 00:00:00',9,5,5,NULL,'2011-07-10 02:10:31','camilo',NULL,NULL,'2011-07-09 00:00:00'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/visu','AR/PN/SC/DNPM/CNSDR','Prueba',NULL,NULL,'0000-01-01 00:00:00',NULL,'12563','AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Visual','Film','Copia auténtica',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'Local',NULL,8,2,2,NULL,'2011-06-17 17:17:50','camilo',NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/Visu','AR/PN/SC/DNPM/CNSDR',NULL,NULL,NULL,NULL,NULL,NULL,'AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'Local',NULL,7,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/cp02_1','AR/pn/SC/DNPM/PSJ/prueba02',NULL,NULL,NULL,NULL,NULL,NULL,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,10,'Local',NULL,4,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/cp02_2','AR/pn/SC/DNPM/PSJ/prueba02',NULL,NULL,NULL,NULL,NULL,NULL,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11,'Local',NULL,4,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02/02','AR/pn/SC/DNPM/PSJ/prueba02','prueba de documentos textuales 02','prueba de documentos textuales 02','prueba de documentos textuales 02','2011-06-28 00:00:00','prueba de documentos textuales 02','prueba de documentos textuales 02','AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02','Audiovisual','Cartas','Borrador',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11,'Local',NULL,5,1,1,NULL,'2011-06-29 15:14:23','camilo',NULL,NULL,NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02/ñ','AR/pn/SC/DNPM/PSJ/prueba02',NULL,NULL,NULL,NULL,NULL,NULL,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,9,'Local',NULL,5,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `documentos_areasnotas` (`codigo_referencia`,`nota_descripcion`,`nota_archivero`,`fuentes`,`fecha_descripcion`,`fecha_modificacion`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C/DOCSON','No hay datos.','No hay datos',NULL,NULL,NULL),
...
INSERT INTO `documentos_estados` (`codigo_referencia`,`estado`,`motivo`,`fecha`,`usuario`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C/com1_1','Inicio',NULL,'2011-07-25 13:27:36','camilo'),
 ('AR/PN/SC/DNPM/CNS/C/com1_2','Inicio',NULL,'2011-07-25 13:27:56','camilo'),
 ...
 ('AR/PN/SC/DNPM/CNS/C/DOCSON','Completo',NULL,'2011-06-29 17:14:20','camilo'),
 ('AR/PN/SC/DNPM/CNS/C/DOCSON','Completo',NULL,'2011-06-29 17:15:09','camilo'),
 ...
 ('AR/PN/SC/DNPM/CNS/C/DOCSON','Vigente',NULL,'2011-06-29 17:40:14','camilo'),
 ...
 ('AR/PN/SC/DNPM/CNS/C/DOCVIS01','Vigente',NULL,'2011-07-04 16:41:16','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/cp02_1','Inicio',NULL,'2011-07-26 05:05:17','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/cp02_2','Inicio',NULL,'2011-07-26 05:05:24','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02/02','Inicio',NULL,'2011-06-29 11:11:05','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02/02','Pendiente',NULL,'2011-06-29 11:23:44','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02/ñ','Inicio',NULL,'2011-07-01 18:02:18','camilo');
...
INSERT INTO `documentos_prestamos` (`codigo_referencia`,`fecha_inicio`,`forma`,`institucion_destinataria`,`fecha_termino`,`norma_legal_prestamo`,`nro_legal_prestamo`,`transporte`,`nombre_deposito`,`estanteria_deposito`,`contenedor_deposito`,`grilla_deposito`,`planera_deposito`,`nombre_exhibicion`,`vitrinas_paredes_exhibicion`,`fecha_devolucion`,`full`) VALUES 
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/son','2011-12-12 00:00:00','Prestamo','AR/PN/SC/DNPM/MNG',NULL,'Ordenanza','123',NULL,'12','12','12','12','12','12','12','2011-12-12 00:00:00',1);
...
INSERT INTO `documentos_robados` (`codigo_referencia`,`fecha_sustraido`,`fecha_resolucion_apertura_sumario`,`fecha_resolucion_cierre_sumario`,`denunciante`,`nro_causa_judicial`,`nro_juzgado`,`tipo_tramite_administrativo`,`nro_sumario_administrativo`,`fallo`,`fecha_recuperacion`,`object_id_interpol`,`fecha_registro_interpol`,`full`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C/DOCSON','2011-07-01 00:00:00',NULL,NULL,'Testeo',NULL,NULL,NULL,NULL,NULL,'2011-07-04 00:00:00',NULL,NULL,0),
 ('AR/PN/SC/DNPM/CNS/C/DOCVIS01','2010-02-01 00:00:00',NULL,NULL,'Tester',NULL,NULL,'1236','6321','123/258',NULL,NULL,NULL,0),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/son','2001-01-01 00:00:00','2002-01-01 00:00:00','2002-02-02 00:00:00','Karina Saez','12341234','12341324','XX','123','ajñsldkfjañlsdkfjadsfadsafa','2011-02-01 00:00:00','828282','2011-12-12 00:00:00',1),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/son','2011-12-12 00:00:00',NULL,NULL,'Claudio Andrilli',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp/text','2002-01-01 00:00:00',NULL,NULL,'Hugo Sigal',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);
...
INSERT INTO `formas_autorizadas_nombre` (`codigo_formas_autorizadas_nombre`,`codigo_identificacion`,`forma_autorizada_nombre`) VALUES 
 ...
 (32,'AR/pn/SC/DNPM/PSJ/prueba02','prueba02'),
 (37,'DNPYM','Dirección Nacional de Patrimonio y Museos'),
 (39,'AR/PN/SCN/DNPM/MHS','Museo Histórico Sarmiento'),
 (40,'AR/PN/SCN/DNPM/INET','Instuto Nacional de Estudios de Teatro');
...
INSERT INTO `instituciones` (`codigo_identificacion`,`formas_conocidas_nombre`,`tipo_institucion`,`tipo_entidad`,`telefono_de_contacto`,`email`,`www`,`historia`,`estructura_organica`,`politicas_ingresos`,`proyecto_nuevos_ingresos`,`instalaciones_archivo`,`fondos_agrupaciones`,`tipo_acceso`,`requisito_acceso`,`acceso_documentacion`,`dias_apertura`,`horaios_apertura`,`fechas_anuales_cierre`,`codigo_interno`,`estado`,`fecha_ultima_modificacion`,`usuario`) VALUES 
 ...
 ('AR/DNPP/PSJ/PRUEBA02','Prueba-02','Sociedad Civil',NULL,'probando sin número de teléfono de contacto','probando formato sin arroba',NULL,'Sin datos','Sin datos','Sin datos','Sin datos','Sin datos','1','Arancelado - Libre',NULL,NULL,'sin fechas',NULL,'sin fechas',NULL,4,'2011-06-29 15:23:45','camilo'),
...
INSERT INTO `instituciones` (`codigo_identificacion`,`formas_conocidas_nombre`,`tipo_institucion`,`tipo_entidad`,`telefono_de_contacto`,`email`,`www`,`historia`,`estructura_organica`,`politicas_ingresos`,`proyecto_nuevos_ingresos`,`instalaciones_archivo`,`fondos_agrupaciones`,`tipo_acceso`,`requisito_acceso`,`acceso_documentacion`,`dias_apertura`,`horaios_apertura`,`fechas_anuales_cierre`,`codigo_interno`,`estado`,`fecha_ultima_modificacion`,`usuario`) VALUES 
 ('AR/pn/SC/DNPM/PSJ/prueba02','prueba02','Sociedad Civil',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2011-06-28 15:40:15',NULL),
 ('AR/PN/SCN/DNPM/INET','INET','Estatal',NULL,'5411 4815-8817 ','mlastrabelgrano@inet.gov.ar <mlastrabelgrano@inet.','-','Creado en 1936, al mismo tiempo que la Comedia Nacional y el Conservatorio Nacional de Arte Dramático, este Museo tiene hoy su sede en la planta baja del Teatro Nacional Cervantes.\r\n\r\nEs un edificio de estilo Barroco Español, su puerta principal es entrada a un mundo de fotografías, afiches y programas de mano que cuentan la historia de la dramaturgia nacional.\r\n\r\nSus salas albergan memoria de la actividad teatral desde los días coloniales, pasando por la Revolución de Mayo, la Independencia, la Federación, la Comedia Nacional y más.Los documentos históricos se alternan con plantas escenográficas, vestuario y objetos personales de actores, actrices, directoresa y autores de la escena argentina.\r\n\r\nEn la sala principal (Trinidad Guevara) se desarrollan actividades de extensión: teatro leído, presentaciones de libros, exposiciones temáticas, ciclos de teatro argentino filmado, cuento teatralizado, talleres y jornadas de investigación, en conjunto con otras entidades del medio.\r\n\r\nEl Museo cuenta con el archivo documental sobre teatro más amplio del país, con material genuino que puede ser consultado a través de su biblioteca Las tres unidades funcionales: Museo, Archivo Documental y Biblioteca forman parte del Instituto Nacional de Estudios de Teatro .','dsdsdsdsdds','gsgsgsgsgsggs','fafafafafa','bcbcbcbcbcbcbcbbc','1','Arancelado - Libre',NULL,NULL,'Lunes a viernes de 10 a 18 ',NULL,'enero',NULL,4,'2011-07-26 13:48:26','camilo'),
 ('AR/PN/SCN/DNPM/MHS','Museo Sarmiento','Estatal',NULL,'------------------','mhs@cultura.gov.ar','www.mhs.gov.ar','xxxxxx','un director y dos empleados','xxxxxx','No hay datos disponibles','una oficina','1','Arancelado - Solo para investigadores',NULL,NULL,'lunes 14 a 17',NULL,'xxxx',NULL,4,'2011-07-14 16:19:01','camilo'),
 ('DNPYM','DNPyM','Estatal',NULL,'4129-2486  ','dnpm@cultura.gov.ar',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,'2011-07-05 17:01:35','camilo');
...
INSERT INTO `instituciones_estados` (`codigo_referencia`,`estado`,`motivo`,`fecha`,`usuario`) VALUES 
 ...
 ('AR/PN/SC/DNPM/CNS','Completo',NULL,'2011-06-29 17:31:15','camilo'),
 ('AR/PN/SC/DNPM/CNS','Completo',NULL,'2011-06-29 17:32:25','camilo'),
 ('AR/PN/SC/DNPM/CNS','Completo',NULL,'2011-06-29 17:32:38','camilo'),
 ('AR/PN/SC/DNPM/CNS','Completo',NULL,'2011-07-01 15:58:25',NULL),
 ('AR/PN/SC/DNPM/CNS','Pendiente',NULL,'2011-05-24 04:45:52','camilo'),
 ('AR/PN/SC/DNPM/CNS','Vigente',NULL,'2011-06-29 17:31:56','camilo'),
 ('AR/PN/SC/DNPM/CNS','Vigente',NULL,'2011-06-29 17:38:10','camilo'),
 ('AR/PN/SC/DNPM/CNS','Vigente',NULL,'2011-07-04 16:41:05','camilo'),
 ...
 ('AR/PN/SC/DNPM/PSJ','Vigente',NULL,'2011-07-04 16:44:02','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02','Inicio',NULL,'2011-06-28 15:37:44',NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02','Pendiente',NULL,'2011-06-28 15:40:15',NULL),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-24 02:16:29','camilo'),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-24 02:16:38','camilo'),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-24 02:16:54','camilo'),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-24 02:17:24','camilo'),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-24 02:17:38','camilo'),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-24 02:19:32','camilo'),
 ('AR/PN/SCN/DNPM/INET','Completo',NULL,'2011-07-26 13:48:15','camilo'),
 ('AR/PN/SCN/DNPM/INET','Inicio',NULL,'2011-07-24 01:53:48','camilo'),
 ('AR/PN/SCN/DNPM/INET','Pendiente',NULL,'2011-07-24 02:03:46','camilo'),
 ('AR/PN/SCN/DNPM/MHS','Completo',NULL,'2011-07-14 16:19:58','camilo'),
 ('AR/PN/SCN/DNPM/MHS','Completo',NULL,'2011-07-14 16:20:25','camilo'),
 ('AR/PN/SCN/DNPM/MHS','Inicio',NULL,'2011-07-14 15:55:25','camilo'),
 ('AR/PN/SCN/DNPM/MHS','Pendiente',NULL,'2011-07-14 15:56:14','camilo'),
 ('DNPYM','Inicio',NULL,'2011-07-05 16:53:19','camilo'),
 ('DNPYM','Pendiente',NULL,'2011-07-05 16:56:57','camilo');
...
INSERT INTO `niveles` (`codigo_referencia`,`codigo_institucion`,`titulo_original`,`titulo_atribuido`,`titulo_traducido`,`fecha_registro`,`numero_registro_inventario_anterior`,`fondo_tesoro_sn`,`fondo_tesoro`,`fecha_inicial`,`fecha_final`,`alcance_contenido`,`metros_lineales`,`unidades`,`historia_institucional_productor`,`historia_archivistica`,`forma_ingreso`,`procedencia`,`fecha_inicio_ingreso`,`precio`,`norma_legal_ingreso`,`numero_legal_ingreso`,`numero_administrativo`,`derechos_restricciones`,`titular_derecho`,`publicaciones_acceso`,`subsidios_otorgados`,`tipo_nivel`,`cod_ref_sup`,`tv`,`numero_registro`,`tipo_acceso`,`requisito_acceso`,`acceso_documentacion`,`estado`,`normativa_legal_baja`,`numero_norma_legal`,`motivo`,`fecha_baja`,`fecha_ultima_modificacion`,`usuario_ultima_modificacion`,`na`) VALUES 
 ...
 ('AR/PN/SC/DNPM/CNS/C','AR/PN/SC/DNPM/CNS','titulo','titulo',NULL,'0000-01-01 00:00:00',NULL,0x00,NULL,'0000-01-01 00:00:00','0000-01-01 00:00:00','No hay datos','No hay datos','No hay datos','No hay datos','No hay datos','No hay datos','No hay datos','00000101',NULL,NULL,NULL,NULL,'No hay datos','No hay datos','No hay datos','No hay datos',1,'AR/PN/SC/DNPM/CNS',1,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'2011-06-29 17:23:56','camilo',4),
 ('AR/PN/SC/DNPM/CNS/C/com1','AR/PN/SC/DNPM/CNS',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'AR/PN/SC/DNPM/CNS/C',2,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 ...
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','AR/PN/SC/DNPM/CNSDR','Título','Atribuido','Traducido.','2000-01-01 00:00:00',NULL,0x00,'Ver que se borre...','1900-01-01 00:00:00','2000-01-01 00:00:00','Alcance','1300','1233','h','h','Intacto','Procedencia','20090101',NULL,NULL,NULL,NULL,'d','t','p','s',4,'AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser',7,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'2011-07-04 15:44:37','camilo',4),
 ...
 ('AR/PN/SC/DNPM/INET/Agrupacion','AR/PN/SC/DNPM/INET',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,'AR/PN/SC/DNPM/INET',1,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/PN/SC/DNPM/INET/Fondo1','AR/PN/SC/DNPM/INET',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'AR/PN/SC/DNPM/INET',1,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
...
INSERT INTO `niveles` (`codigo_referencia`,`codigo_institucion`,`titulo_original`,`titulo_atribuido`,`titulo_traducido`,`fecha_registro`,`numero_registro_inventario_anterior`,`fondo_tesoro_sn`,`fondo_tesoro`,`fecha_inicial`,`fecha_final`,`alcance_contenido`,`metros_lineales`,`unidades`,`historia_institucional_productor`,`historia_archivistica`,`forma_ingreso`,`procedencia`,`fecha_inicio_ingreso`,`precio`,`norma_legal_ingreso`,`numero_legal_ingreso`,`numero_administrativo`,`derechos_restricciones`,`titular_derecho`,`publicaciones_acceso`,`subsidios_otorgados`,`tipo_nivel`,`cod_ref_sup`,`tv`,`numero_registro`,`tipo_acceso`,`requisito_acceso`,`acceso_documentacion`,`estado`,`normativa_legal_baja`,`numero_norma_legal`,`motivo`,`fecha_baja`,`fecha_ultima_modificacion`,`usuario_ultima_modificacion`,`na`) VALUES 
 ...
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02','AR/pn/SC/DNPM/PSJ/prueba02','subfondo de la prueba dos no editable pero agregable, sin código definido','aca va el título atribuido','titulo de traduccion','1979-01-08 00:00:00','2147483647',0x00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'AR/pn/SC/DNPM/PSJ/prueba02',1,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,'2011-06-28 16:13:48','camilo',1),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202','AR/pn/SC/DNPM/PSJ/prueba02',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02',2,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/cp02','AR/pn/SC/DNPM/PSJ/prueba02',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202',3,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02','AR/pn/SC/DNPM/PSJ/prueba02','Este es el fondo/subfondo de prueba02','Este es el fondo/subfondo de prueba02','Este es el fondo/subfondo de prueba02','1979-01-01 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202',3,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,'2011-06-28 16:17:54','camilo',1),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02','AR/pn/SC/DNPM/PSJ/prueba02','agrupacion de prueba 02','agrupacion de prueba 02','agrupacion de prueba 02','1979-07-08 00:00:00',NULL,0x00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,'AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02',4,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,'2011-06-28 16:20:09','camilo',1),
 ('AR/PN/SCN/DNPM/MHS/DS','AR/PN/SCN/DNPM/MHS',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'AR/PN/SCN/DNPM/MHS',1,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `niveles_areasnotas` (`codigo_referencia`,`nota_descripcion`,`nota_archivero`,`fuentes`,`fecha_descripcion`,`fecha_modificacion`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C','No hay datos','No hay datos','No hay datos','0000-01-01 00:00:00','2011-06-29 17:26:57'),
 ...
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','n','n','sep','2010-01-01 00:00:00','2011-07-04 15:45:04'),
...
INSERT INTO `niveles_estados` (`codigo_referencia`,`estado`,`motivo`,`fecha`,`usuario`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C','Completo',NULL,'2011-06-29 17:24:05','camilo'),
 ('AR/PN/SC/DNPM/CNS/C','Completo',NULL,'2011-06-29 17:26:57','camilo'),
 ('AR/PN/SC/DNPM/CNS/C','Inicio',NULL,'2011-05-24 10:18:57','camilo'),
 ('AR/PN/SC/DNPM/CNS/C','Pendiente',NULL,'2011-06-29 17:22:44','camilo'),
 ('AR/PN/SC/DNPM/CNS/C','Vigente',NULL,'2011-06-29 17:38:18','camilo'),
 ('AR/PN/SC/DNPM/CNS/C/com1','Vigente',NULL,'2011-07-25 13:27:19','camilo'),
 ...
 ('AR/PN/SC/DNPM/CNS/MH','Vigente',NULL,'2011-07-04 16:41:20','camilo'),
 ...
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Completo',NULL,'2011-07-04 15:44:53','camilo'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Completo',NULL,'2011-07-04 15:45:04','camilo'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Inicio',NULL,'2011-06-17 13:55:41','camilo'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Pendiente',NULL,'2011-07-04 15:41:26','camilo'),
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc/doccomp','Vigente',NULL,'2011-06-17 13:55:58','camilo'),
 ('AR/PN/SC/DNPM/INET/Agrupacion','Inicio',NULL,'2011-06-28 16:55:38','camilo'),
 ('AR/PN/SC/DNPM/INET/Fondo1','Inicio',NULL,'2011-06-28 16:55:23','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FDCA','Vigente',NULL,'2011-07-04 16:41:42','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FJJU','Vigente',NULL,'2011-07-04 16:41:49','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FJMG','Vigente',NULL,'2011-07-04 16:44:36','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FJMR','Vigente',NULL,'2011-07-04 16:44:52','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FJMR/MaxT','Vigente',NULL,'2011-07-04 16:46:38','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FJMR/MaxT/E','Vigente',NULL,'2011-07-04 16:48:32','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FPRT','Vigente',NULL,'2011-07-04 16:49:05','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FRGP','Vigente',NULL,'2011-07-04 16:51:14','camilo'),
 ...
 ('AR/PN/SC/DNPM/MCASN/FSRG','Vigente',NULL,'2011-07-04 19:01:52','camilo'),
 ...
 ('AR/PN/SC/DNPM/PSJ/FDC','Vigente',NULL,'2011-07-04 16:45:23','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02','Inicio',NULL,'2011-06-28 15:45:32','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02','Pendiente',NULL,'2011-06-28 15:47:00','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202','Inicio',NULL,'2011-06-28 15:53:02','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/cp02','Vigente',NULL,'2011-07-26 05:05:08','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02','Inicio',NULL,'2011-06-28 16:14:31','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02','Pendiente',NULL,'2011-06-28 16:17:54','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02','Inicio',NULL,'2011-06-28 16:19:04','camilo'),
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02/depruebanivel202/subseccion de prueba 02/Agrupacion de prueba02','Pendiente',NULL,'2011-06-28 16:20:09','camilo'),
 ('AR/PN/SCN/DNPM/MHS/DS','Inicio',NULL,'2011-07-14 16:28:18','camilo');
...
INSERT INTO `niveles_inventario` (`codigo_referencia`,`numero_inventario`) VALUES 
 ...
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02',2147483647);
...
INSERT INTO `palabras_claves` (`palabra_clave`,`codigo_referencia`) VALUES 
 ...
 ('GOB','AR/PN/SC/DNPM/CNS/C/DOCVIS01');
...
CREATE TABLE `permisos` (
  ...
  `accion` varchar(1) DEFAULT 'C',
  PRIMARY KEY (`idseccion`,`idrol`),
...
INSERT INTO `permisos` (`idseccion`,`idrol`,`accion`) VALUES 
 (1,4,'E'),
 (1,5,'E'),
 (1,6,'E'),
 (2,4,'E'),
...
CREATE TABLE `rel_documentos_exposiciones` (
  ...
  `fecha_devolucion` datetime DEFAULT NULL,
  `full` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`codigo_referencia`,`codigo_exposicion`,`fecha_entrega`),
...
INSERT INTO `rel_instituciones_serviciosdereproduccion` (`codigo_institucion`,`servicio_reproduccion`) VALUES 
 ...
 ('AR/PN/SC/DNPM/CNS','Copiar'),
 ('AR/PN/SC/DNPM/MCASN','Copiar'),
 ('AR/PN/SCN/DNPM/INET','Digitalizar'),
...
INSERT INTO `rel_niveles_contenedores` (`codigo_referencia`,`contenedor`,`ruta_acceso`) VALUES 
 ...
 ('AR/PN/SC/DNPM/CNS/C','No posee','No posee'),
 ...
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','No posee','No posee'),
 ...
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02','URL','http://prueba.com');
...
INSERT INTO `rel_niveles_edificios` (`codigo_referencia`,`nombre_edificio`,`ubicacion_topografica`) VALUES 
 ...
 ('AR/PN/SC/DNPM/CNS/C','Museo Casa Natal de Sarmiento','Caja 1, Mesa 2'),
 ...
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Museo Casa de Yrurtia','Cajón 123'),
 ...
 ('AR/pn/SC/DNPM/PSJ/prueba02/deprueba02','Museo Regional de Pintura José A. Terry','av belgrano 3671');
...
INSERT INTO `rel_niveles_productores` (`codigo_referencia`,`nombre_productor`) VALUES 
 ('AR/PN/SC/DNPM/CNS/C','Casa Natal de Sarmiento. Monumento Histórico'),
 ...
 ('AR/PN/SC/DNPM/CNSDR/fdo01/subfdo/secc/subsecc/serie/subser/AgrupDoc','Productor'),
...
INSERT INTO `rel_usuarios_instituciones` (`idrel_usuarios_instituciones`,`idusuario`,`codigo_identificacion`) VALUES 
 (11,1,'AR/PN/SC/DNPM/CNS'),
 (12,8,'AR/pn/SC/DNPM/PSJ/prueba02'),
 (13,9,'AR/pn/SC/DNPM/PSJ/prueba02'),
 (14,10,'DNPYM'),
 (15,11,'DNPYM'),
 (16,12,'DNPYM');
...
INSERT INTO `responsable_archivo` (`codigo_responsable`,`apellido`,`nombre`,`area_responsabilidad`,`email`,`telefono`,`movil`,`codigo_institucion`) VALUES 
 ...
 (35,'Petrina','Alberto','Director Nacional de Patrimonio y Museos','dnpm@cultura.gov.ar','4129-2486 ',NULL,'DNPYM'),
 (36,'De Muro','adriana','Encargada de restauración','demuro@cultura.gov.ar',NULL,NULL,'AR/PN/SCN/DNPM/MHS'),
 (37,'Arens','Susana',NULL,'bv','765','-','AR/PN/SCN/DNPM/INET');
...
INSERT INTO `responsable_institucion` (`codigo_responsable`,`apellido`,`nombre`,`area_responsabilidad`,`email`,`telefono`,`movil`,`codigo_institucion`) VALUES 
 ...
 (36,'Petrina','Alberto','Director Nacional de Patrimonio y Museos',NULL,NULL,NULL,'DNPYM'),
 (37,'Gaudencio de Germani','Marta','directora','mgermani@cultura.gov.ar','alberto',NULL,'AR/PN/SCN/DNPM/MHS'),
 (38,'gg','gg','908','gg','gg','567','AR/PN/SCN/DNPM/INET');
...
INSERT INTO `roles` (`idrol`,`rol`,`activo`) VALUES 
 (1,'Administrador Sistemas',0x01),
 (2,'Administrador DNPyM',0x01),
 (3,'Administrador Institucion',0x01),
...
CREATE TABLE `secciones` (
  ...
  `cod_secc` varchar(4) DEFAULT NULL,
  PRIMARY KEY (`idseccion`),
  UNIQUE KEY `descripcion_UNIQUE` (`descripcion`),
  UNIQUE KEY `cod_secc_UNIQUE` (`cod_secc`)
...
INSERT INTO `secciones` (`idseccion`,`descripcion`,`cod_secc`) VALUES 
 (1,'Instituciones - Area Identificación','INS1'),
 (2,'Instituciones - Area Descripción','INS2'),
 (3,'Instituciones - Area Administración','INS3'),
 (4,'Instituciones - Area Notas','INS4'),
 (5,'Niveles - Area Administración','NIV1'),
 (6,'Niveles - Area Descripción','NIV2'),
 (7,'Niveles - Area Identificación','NIV3'),
 (8,'Niveles - Area Notas','NIV4'),
 (9,'Diplomaticos - Area Administración','DIP1'),
 (10,'Diplomaticos - Area Descripción','DIP2'),
 (11,'Diplomaticos - Area Identificación','DIP3'),
 (12,'Diplomaticos - Area Notas','DIP4'),
 (13,'Búsqueda - Vigencia','BVIG'),
 (14,'Reportes - Inventario','RINV'),
 (15,'Reportes - Gestión','RGES'),
 (16,'Reportes - Conservación','RCON'),
 (17,'Gestión - Conservación','GCON'),
 (18,'Gestión - Exposición','GEXP'),
 (19,'Gestión - Préstamo','GPRE'),
 (20,'Gestión - Robo','GROB'),
 (21,'Gestión - No Localizado','GNLO');
...
INSERT INTO `tips` (`idtips`,`tip`,`area`,`requerido`) VALUES 
 ...
 (126,'Exposición a la cual se envía el documento. La misma debe cargarse desde Administración -> Exposiciones','Exposición',1),
 (127,'Número asignado al documento en la exposición.','Exposición',1),
 (128,'Fecha de devolución del documento luego de la finalización de la exposición','Exposición',0),
 (129,'Fecha en la que se detecta la falta de un documento.','No Localizado',1),
 (130,'Número de la nota en donde se detalla la falta','No Localizado',1),
 (131,'Motivo que se asocia a la falta del documento.','Exposición',1),
 (132,'Fecha de Recuperación del documento, esta fecha vuelve a modificar la fecha de último relevamiento visú.','Exposición',0),
 (133,'Fecha en la que se efectúa el préstamo del documento','Prestamo',1),
 (134,'Forma en la que se realiza el préstamo','Prestamo',1),
 (135,'Institución a la que se le presta el documento','Prestamo',1),
 (136,'Norma legal por la que se efectúa el préstamo.','Prestamo',1),
 (137,'Número Legal asociado a la norma de préstamo.','Prestamo',1),
 (138,'Transporte utilizado para trasladar el documento','Exposición',0),
 (139,'Nombre del depósito en donde se ubicará el documento durante el préstamo.','Prestamo',0),
 (140,'Estantería en donde se depositará el documento durante el préstamo.','Exposición',0),
 (141,'Contenedor en donde se ubicará el documento durante el préstamo.','Prestamo',0),
 (142,'Grilla en donde se ubicará el documento durante el préstamo.','Prestamo',0),
 (143,'Planera en donde se ubica el documento durante el préstamo.','Prestamo',0),
 (144,'Nombre de la Exhibición a realizar','Prestamo',0),
 (145,'Vitrinas y paredes que intervienen en la exhibición.','Prestamo',0),
 (146,'Fecha fin del préstamo.','Prestamo',0),
 (147,'Fecha de devolución del documento, esta fecha modifica la fecha de último relevamiento visú.','Prestamo',0);
...
INSERT INTO `usuarios` (`idusuario`,`usuario`,`pass`,`fecha_alta`,`nombre`,`apellido`,`email`,`telefono`,`activo`,`fecha_ultimo_acceso`,`fecha_baja`) VALUES 
 (1,'camilo','0efc84d4433e3e96646c6dc6a6b826b0',NULL,'camilo','schimf','mschimf@gylgroup.com','48284257',1,NULL,NULL),
 (8,'gnazar','0764a665f985af0f5388419481e8a319','2011-07-13 14:48:22','Gabriela','Nazar','gnazar@gylgroup.com','4828-4200',1,NULL,NULL),
 (9,'eperez','e5a329b2dace4a58fe4fc5a3c4623ee9','2011-07-13 14:51:39','Estela','Pérez','Pérez','4828-4200',1,NULL,NULL),
 (10,'claudia','60855b8257f199034f984eef626e9435','2011-07-15 17:52:07','Claudia','Cabouli','ccabouli@cultura.gov.ar',NULL,1,NULL,NULL),
 (11,'estela','8ec0ecee76dc893fba5459f126b859ae','2011-07-15 18:11:17','Estela','Pagani','estelapagani@gmail.com',NULL,1,NULL,NULL),
 (12,'admin','21232f297a57a5a743894a0e4a801fc3','2011-07-26 16:45:55','Admin','Administracion de Cultura','admin@cultura.gob.ar',NULL,1,NULL,NULL);
...
DROP TABLE IF EXISTS `vis_niveles`;
DROP VIEW IF EXISTS `vis_niveles`;
CREATE VIEW `vis_niveles` AS (select `instituciones`.`codigo_identificacion` AS `codigo_referencia`,'0' AS `tipo`,`instituciones`.`formas_conocidas_nombre` AS `nombre`,(select `instituciones_estados`.`estado` AS `estado` from `instituciones_estados` where (`instituciones`.`codigo_identificacion` = `instituciones_estados`.`codigo_referencia`) order by `instituciones_estados`.`fecha` desc limit 1) AS `estado`,max(`instituciones_estados`.`fecha`) AS `fecha`,'0' AS `cod_ref_sup`,`instituciones`.`codigo_identificacion` AS `codigo_institucion` from (`instituciones` join `instituciones_estados` on((`instituciones`.`codigo_identificacion` = `instituciones_estados`.`codigo_referencia`))) where (0 = 0) group by `instituciones`.`codigo_identificacion`) union (select `niveles`.`codigo_referencia` AS `codigo_referencia`,`niveles`.`tipo_nivel` AS `tipo`,`niveles`.`titulo_original` AS `nombre`,(select `niveles_estados`.`estado` AS `estado` from `niveles_estados` where (`niveles`.`codigo_referencia` = `niveles_estados`.`codigo_referencia`) order by `niveles_estados`.`fecha` desc limit 1) AS `estado`,max(`niveles_estados`.`fecha`) AS `fecha`,`niveles`.`cod_ref_sup` AS `cod_ref_sup`,`niveles`.`codigo_institucion` AS `codigo_institucion` from (`niveles` join `niveles_estados` on((`niveles`.`codigo_referencia` = `niveles_estados`.`codigo_referencia`))) where (0 = 0) group by `niveles`.`codigo_referencia`) union (select `documentos`.`codigo_referencia` AS `codigo_referencia`,`documentos`.`tipo_diplomatico` AS `tipo`,`documentos`.`titulo_original` AS `nombre`,(select `documentos_estados`.`estado` AS `estado` from `documentos_estados` where (`documentos_estados`.`codigo_referencia` = `documentos`.`codigo_referencia`) order by `documentos_estados`.`fecha` desc limit 1) AS `estado`,max(`documentos_estados`.`fecha`) AS `fecha`,`documentos`.`cod_ref_sup` AS `cod_ref_sup`,`documentos`.`codigo_institucion` AS `codigo_institucion` from (`documentos` join `documentos_estados` on((`documentos`.`codigo_referencia` = `documentos_estados`.`codigo_referencia`))) where (0 = 0) group by `documentos`.`codigo_referencia`) order by `codigo_referencia`;

--
-- Definition of view `vis_permisos`
--

DROP TABLE IF EXISTS `vis_permisos`;
DROP VIEW IF EXISTS `vis_permisos`;
CREATE VIEW `vis_permisos` AS select `u`.`idrel_usuarios_roles_instituciones` AS `idrel_usuarios_roles_instituciones`,`r`.`idrel_usuarios_instituciones` AS `idrel_usuarios_instituciones`,`s`.`idusuario` AS `idusuario`,`s`.`usuario` AS `logusuario`,`s`.`pass` AS `pass`,`s`.`nombre` AS `nombre`,`s`.`apellido` AS `apellido`,`s`.`activo` AS `usuarioactivo`,`l`.`idrol` AS `idrol`,`l`.`rol` AS `rol`,`l`.`activo` AS `activo`,`i`.`codigo_identificacion` AS `codigo_identificacion`,`i`.`formas_conocidas_nombre` AS `formas_conocidas_nombre`,`i`.`tipo_institucion` AS `tipo_institucion`,`i`.`tipo_entidad` AS `tipo_entidad`,`i`.`telefono_de_contacto` AS `telefono_de_contacto`,`i`.`email` AS `email`,`i`.`www` AS `www`,`i`.`historia` AS `historia`,`i`.`estructura_organica` AS `estructura_organica`,`i`.`politicas_ingresos` AS `politicas_ingresos`,`i`.`proyecto_nuevos_ingresos` AS `proyecto_nuevos_ingresos`,`i`.`instalaciones_archivo` AS `instalaciones_archivo`,`i`.`fondos_agrupaciones` AS `fondos_agrupaciones`,`i`.`tipo_acceso` AS `tipo_acceso`,`i`.`requisito_acceso` AS `requisito_acceso`,`i`.`acceso_documentacion` AS `acceso_documentacion`,`i`.`dias_apertura` AS `dias_apertura`,`i`.`horaios_apertura` AS `horaios_apertura`,`i`.`fechas_anuales_cierre` AS `fechas_anuales_cierre`,`i`.`codigo_interno` AS `codigo_interno`,`i`.`estado` AS `estado`,`i`.`fecha_ultima_modificacion` AS `fecha_ultima_modificacion`,`i`.`usuario` AS `usuario` from ((((`rel_usuarios_roles_instituciones` `u` join `rel_usuarios_instituciones` `r` on((`u`.`idrel_usuarios_instituciones` = `r`.`idrel_usuarios_instituciones`))) join `roles` `l` on((`u`.`idrol` = `l`.`idrol`))) join `usuarios` `s` on((`r`.`idusuario` = `s`.`idusuario`))) join `instituciones` `i` on((`r`.`codigo_identificacion` = `i`.`codigo_identificacion`)));
