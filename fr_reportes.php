...
<table width="1334" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" style="background:url(images/angulo_06.jpg);"><iframe width="600" src="<?php echo $_GET['reporte']?>.php" height="<?php echo $_SESSION['MM_Height']-60; ?>" frameborder="0" name="frizquierda" id="frizquierda"></iframe></td>
    <td>&nbsp;</td>
