...
<table width="1334" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" style="background:url(images/angulo_12.jpg)"><iframe width="1300" src="<?php echo $_GET['p']; ?>.php" height="<?php echo $_SESSION['MM_Height']-60; ?>" frameborder="0" name="frambos" id="frambos"></iframe></td>
  </tr>
  <tr>
