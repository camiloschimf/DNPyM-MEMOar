...
//	$sect->writeText('<br>', new PHPRtfLite_Font(), new PHPRtfLite_ParFormat());
	...
	do {
		...
		// columna 2
		$cell = $table->getCell(1, 1);
		$cell->writeText($row_Imprimir['codigo_referencia'], new PHPRtfLite_Font(11, 'Arial'), new PHPRtfLite_ParFormat());
		$cell->writeText($row_Imprimir['nombre'], new PHPRtfLite_Font(11, 'Arial'), new PHPRtfLite_ParFormat());
		$cell->writeText(desfechar($row_Imprimir['fecha']), new PHPRtfLite_Font(11, 'Arial'), $parListado);
